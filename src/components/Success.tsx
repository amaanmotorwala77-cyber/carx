        ...
        >
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-6 mb-10 text-left space-y-6">
            <div className="flex items-center gap-5">
              <div className="size-16 rounded-lg bg-cover bg-center shrink-0 border border-white/10" style={{ backgroundImage: "url('https://i.ibb.co/ksMTftQx/PHOTO-2025-09-26-19-34-56.jpg')" }}></div>
              <div>
