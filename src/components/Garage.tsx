...
import { db, auth, collection, query, where, onSnapshot, deleteDoc, doc, Timestamp, handleFirestoreError, OperationType } from "../firebase";
...
export default function Garage({ onNavigate }: GarageProps) {
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      ...
      handleFirestoreError(error, OperationType.DELETE, `builds/${id}`);
    }
  };
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div>
            ...
            <motion.h1 
              ...
              className="text-4xl md:text-6xl font-bold uppercase italic flex flex-wrap items-center gap-4"
            >
