...
export default function Header({ onNavigate, currentPage, user, isAdmin, hasKey, onSelectKey }: HeaderProps) {
    ...
    <header className="sticky top-0 z-50 w-full border-b border-white/5 bg-background-dark/80 backdrop-blur-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-10">
        ...
        <div className="flex items-center gap-4">
          <button 
            onClick={onSelectKey}
            className={`flex items-center gap-2 rounded-lg border px-3 py-1.5 sm:px-4 sm:py-2 text-[9px] sm:text-[10px] font-bold uppercase tracking-widest transition-all ${
              hasKey 
          ...
          >
            ...
            <span className="hidden xs:inline">{hasKey ? "AI Active" : "AI Offline"}</span>
            <span className="xs:hidden">{hasKey ? "Active" : "Offline"}</span>
          </button>
          ...
          >
            <div className="px-6 py-6 space-y-4">
              ...
              <button
                ...
                className={`block w-full text-left text-sm font-bold py-3 px-4 rounded-lg border flex items-center gap-3 mb-4 ${
                  hasKey 
              ...
              >
                ...
                <div className="flex flex-col items-start">
                  ...
                  {!hasKey && <span className="text-[8px] opacity-60">If button fails, use Settings menu</span>}
                </div>
              </button>
              <button
                onClick={() => {
