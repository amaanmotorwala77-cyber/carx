      ...
      <div className="max-w-7xl mx-auto px-6">
        <header className="mb-16">
          <motion.h1 
            ...
            className="text-6xl md:text-8xl font-bold uppercase italic leading-none mb-6 flex flex-wrap items-center gap-6"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-12">
              ...
              <div className="space-y-8">
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400">engineering@aistudio.com</p>
                    <p className="text-slate-400">inquiries@aistudio.com</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <img 
                src="https://i.ibb.co/fd80dCXb/IMG-3961.jpg" 
                alt="Our Workshop" 
              ...
              <div className="absolute bottom-6 left-6">
                <p className="text-xs font-bold uppercase tracking-widest text-primary mb-1">Our Workshop</p>
                <p className="text-lg font-bold uppercase italic">Precision Engineering Lab</p>
              </div>
            </motion.div>
          </div>
        </div>
